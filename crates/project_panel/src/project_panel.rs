...
use ui::{prelude::*, v_flex, ContextMenu, Icon, IconColor, KeyBinding, Label, ListItem, Tooltip};
                            ...
                            div()
                                ...
                                .child(
                                    Icon::new(IconName::ArrowUpRight)
                                        ...
                                        .color(IconColor::Monochrome(filename_text_color)),
                                )
                                .into_any_element(),
                        )
                    })
                    .child(if let Some(icon) = &icon {
                        h_flex().child(Icon::from_path(icon.to_string()).color(IconColor::Monochrome(filename_text_color)))
                    } else {
                        h_flex()
